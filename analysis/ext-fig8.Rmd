---
title: Fragmentation patterns for patients in CheckPAC trial with partial response or stable disease are more closely correlated to healthy plasma
---
...
```{r ext-fig8, fig.width = 36, fig.height = 20, dev = c("png", "pdf") }
fig <- df5 %>%
  group_by(dx) %>%
